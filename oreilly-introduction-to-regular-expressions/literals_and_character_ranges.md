...
However, there is a special set of characters (called **metacharacters**) that have special functionality tied to them we will talk about throughout these scenarios. These characters include the following: 

`[]\^$.|?*+()`

If you want to use any of these characters as literals, you will need to escape them by preceding with a `\`. For example, to match a string of `$180` you will need a regular expression of `\$180`. 
